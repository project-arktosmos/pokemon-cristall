...
BikerDwayneSeenText:
	text "Som la FEDERACIÓ"
	line "#MON de KANTO,"
	cont "entrenadors."

	para "Et passarem per"
	line "sobre!"
	done
...
SupernerdSamSeenText:
	text "Com funciona el"
	line "TREN MAGNÈTIC?"
	done

SupernerdSamBeatenText:
	text "Només vull veure"
