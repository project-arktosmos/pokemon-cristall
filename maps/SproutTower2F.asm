...
SageNicoSeenText:
	text "Per molt que"
	line "lluitem, la TORRE"
	cont "seguirà dempeus."
	done

SageNicoBeatenText:
	text "He lluitat fort,"
	line "però sóc feble."
	done

SageNicoAfterBattleText:
	text "El pilar flexible"
	line "protegeix la TORRE"

	para "fins i tot dels"
	line "terratrèmols."
	done

SageEdmondSeenText:
	text "…Balancejar-se com"
	line "fulles al vent…"
	done
